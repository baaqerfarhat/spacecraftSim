...
class RobomimicDataCollector:
    ...
    .. _documentation: https://github.com/ARISE-Initiative/robomimic/blob/8c23c696260ffb2709b95cd868cf3fc6480afeba/robomimic/config/base_config.py#L167-L173
    """
        ...
        for i in range(value.shape[0]):
            ...
            if num_sub_keys == 2:
                ...
                if sub_keys[1] not in self._dataset[f"env_{i}"][sub_keys[0]]:
                    self._dataset[f"env_{i}"][sub_keys[0]][sub_keys[1]] = []
                # add data to key
    ...
    def _create_new_file(self, fname: str):
        ...
        # Ref: https://github.com/ARISE-Initiative/robomimic/blob/8c23c696260ffb2709b95cd868cf3fc6480afeba/robomimic/envs/env_base.py#L15
        env_type = 2
